...
class PhotoSubmission(models.Model):
    question = models.ForeignKey(Question, on_delete=models.CASCADE, related_name='photo_submissions')
    team = models.ForeignKey(Team, on_delete=models.CASCADE, related_name='photo_submissions')
    photo = models.ImageField(upload_to='photo_submissions/')
    submitted_at = models.DateTimeField(auto_now_add=True)
    is_approved = models.BooleanField(default=False)

    def __str__(self):
        return f"Photo submission by {self.team.name} for {self.question}"
