...
urlpatterns = [
    ...
    path('leader-dashboard/', views.leaderboard, name='leader_dashboard'),
    ...
    path('lobby/<int:lobby_id>/create-team/', views.create_standalone_team, name='create_team'),
    path('create-standalone-team/', views.create_standalone_team, name='create_standalone_team'),
    path('team/<int:team_id>/', views.team_details, name='team_dashboard'),
    ...
    path('manage-lobbies/', views.dashboard, name='manage_lobbies'),
